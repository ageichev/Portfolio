...
CHAT_ID = 146601127
try:
    BOT_TOKEN = '5283663352:AAFcy59lEjEYLZyJcJdBYmhCwrqIjfgnHAQ'
except:
    BOT_TOKEN = ''
...
# игры, проданные более чем милионным тиражом в северной америке    
    @task()
...
#самые высокие пролдажи в Японии
    @task()
