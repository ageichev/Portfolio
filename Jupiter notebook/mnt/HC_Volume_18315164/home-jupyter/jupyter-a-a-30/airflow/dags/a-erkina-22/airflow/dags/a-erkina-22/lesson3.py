...
year = 1994 + hash(f'{"a-erkina-22"}') % 23
...
CHAT_ID = 805008731
try:
    BOT_TOKEN = '5364432568:AAHYUvILeaxycHsAQSYKOAE6BinGBh-i4P0'
except:
    BOT_TOKEN = ''
...
a_erkina_22_lesson_3 = a_erkina_22_lesson_3()
