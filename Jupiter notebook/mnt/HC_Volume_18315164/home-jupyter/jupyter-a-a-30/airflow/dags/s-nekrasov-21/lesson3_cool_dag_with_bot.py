...
def dag_with_bot_nekrasov():
    ...
    def get_number_of_games_EU(task_df):
        ...
        number_of_games_EU = EU_JP_games[EU_JP_games.EU_Sales > EU_JP_games.JP_Sales].Name.count()
    ...
    def print_data(best_sold, top_genre_EU, top_NA_platform, top_JP_publisher, number_of_games_EU):
        ...
        print(f'Top platform games over a million copies in {year} in NA: {top_NA_platform}')
