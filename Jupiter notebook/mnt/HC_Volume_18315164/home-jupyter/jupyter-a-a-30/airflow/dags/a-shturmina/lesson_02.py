...
def top_10_domain_zone():
    ...
    top_data_top_10_domain_zone = top_data_df\
...
default_args = {
    ...
    'start_date': datetime(2022, 09, 6),
}
schedule_interval = '0 12 * * *'

dag = DAG('a_shturmina_lesson_2', default_args=default_args, schedule_interval=schedule_interval)
