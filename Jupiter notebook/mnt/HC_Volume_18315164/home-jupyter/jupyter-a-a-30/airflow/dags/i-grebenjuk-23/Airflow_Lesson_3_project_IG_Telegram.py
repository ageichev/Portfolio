...
#try:
#    BOT_TOKEN = Variable.get('5146510075:AAFPADNik3dxUjPw1LGfZmm7Uw47FjrjhZw')
#except:
#    BOT_TOKEN = ''

#def send_message(context, CHAT_ID, BOT_TOKEN):
#    date = context['ds']
...
def send_message(context):
    date = context['ds']
    dag_id = context['dag'].dag_id
    token = '5146510075:AAFPADNik3dxUjPw1LGfZmm7Uw47FjrjhZw'
    chat_id = 425043044 # your chat id
    message = f'Success with DAG {dag_id} completed on {date}' # text which you want to send
...
def lesson_3_IG_telegram_airflow_2():
...
lesson_3_IG_telegram_airflow_2 = lesson_3_IG_telegram_airflow_2()
