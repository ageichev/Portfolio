...
chat_id = 19572994  
token ='5371281716:AAE55BPbko-GNQi9QPFLTrz-3B-gyyzQvHM'
def send_message(context):
    ...
    base_url = f'https://api.telegram.org/bot/5371281716:AAE55BPbko-GNQi9QPFLTrz-3B-gyyzQvHM'
...
def n_eshmanskaja_lesson_3():
    ...
    @task() # У какого издателя самые высокие средние продажи в Японии? Перечислить все, если их несколько
...
n_eshmanskaja_lesson_3 = n_eshmanskaja_lesson_3()