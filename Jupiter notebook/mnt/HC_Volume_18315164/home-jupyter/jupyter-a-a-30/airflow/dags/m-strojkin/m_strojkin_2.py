...
def get_longest_length_domain():
    ...
    longest_length_domain = top_data_df.sort_values('domain')                         .sort_values('length_domain', ascending=False)                         .head(1)['domain'].values[0]
...
dag = DAG('m-strojkin-2', default_args=default_args)
