...
#     date = ds
    ...
    print(f'Top domains for date')
    print(top_10_domains_zone)

    print(f'Longest_domain for date')
    print(longest_domain)

    print(f'Airflow domain position for date')
    print(airflow_pos)

default_args = {
    'owner': 'a-sozinov', # Владелец операции 
...
dag = DAG('a-sozinov_task_2', default_args=default_args)
